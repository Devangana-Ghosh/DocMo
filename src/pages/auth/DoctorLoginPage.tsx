              ...
              <div className="bg-white rounded-3xl p-10 shadow-lg max-w-md w-full">
                <div className="text-center">
                  ...
                  <h2 className="text-3xl font-bold text-gray-800 mb-6">
                    {t('auth.doctor.portalTitle')}
                  </h2>
                  
                  <p className="text-gray-600 text-lg leading-relaxed">
                    {t('auth.doctor.portalDesc')}
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="max-w-md w-full">
                <div className="text-center mb-8">
                  <h1 className="text-4xl font-bold text-gray-800 mb-4">
                    {isSignUpMode ? t('auth.doctor.signupTitle') : t('auth.doctor.loginTitle')}
                  </h1>
                  <p className="text-gray-600 text-lg">
                    {isSignUpMode ? t('auth.doctor.signupSubtitle') : t('auth.doctor.loginSubtitle')}
                  </p>
                </div>
