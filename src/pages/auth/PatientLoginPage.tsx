              ...
              <div className="bg-white rounded-3xl p-10 shadow-lg max-w-md w-full">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 text-lg leading-relaxed">
                    Manage your health journey with easy access to appointments, records, and prescriptions.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="max-w-md w-full">
                ...
                <div className="mt-8 text-center">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <button className="flex items-center justify-center px-4 py-3 border border-gray-300 rounded-xl hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors">
